...
// Approve button
function approveDoc() {
     localStorage.setItem("workflow_stage", "sent_to_deputy_engineer");

    alert("Engineer Approval Completed — Sent to deputy Engineer");

    // WAIT THEN REDIRECT
    setTimeout(() => {
        window.location.href = "/deputy_dashboard";
    }, 900);
}
